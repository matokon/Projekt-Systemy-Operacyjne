...
#define IPC_ENV_SEM_EMP1_READY "CABLECAR_SEM_EMP1_READY"
#define IPC_ENV_SEM_EMP2_READY "CABLECAR_SEM_EMP2_READY"
#define IPC_ENV_SEM_WORK_AVAIL "CABLECAR_SEM_WORK_AVAIL"
