...
/* Odbiera komunikat z kolejki, weryfikuje SHUTDOWN/validacje i odsyla blad gdy dane niepoprawne. */
...
/* Glowna petla kasjera: przyjmuje prosby, wystawia bilety, reaguje na SHUTDOWN. */
int main() {
    srand(getpid());
